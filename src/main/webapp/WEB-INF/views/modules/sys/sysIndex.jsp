		...
		<div class="navbar-inner">
			...
			<div class="nav-collapse">
				<ul id="menu" class="nav" style="*white-space:nowrap;float:none;">
					...
					<c:forEach items="${fns:getModuleMenuList()}" var="menu" varStatus="idxStatus" begin="0" end="5" step="1">
						...
						<ul class="nav">
							<li><a class="dropdown-toggle" data-toggle="dropdown" href="#"><i class="icon-th-list"></i></a>
								<ul class="dropdown-menu" style="height:600px;overflow:scroll">
									<c:forEach items="${fns:getModuleMenuList()}" var="menu" varStatus="idxStatus" begin="1">
										<li class="menu ${firstMenu ? ' active' : ''}"><a class="menu" href="javascript:" data-href="${ctx}/sys/menu/tree?parentId=${menu.id}" data-id="${menu.id}">${menu.name}</a></li>
										<c:if test="${firstMenu}">
