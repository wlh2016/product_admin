	...
	<div id="main">
		<div id="header" class="navbar navbar-fixed-top">
			<div class="navbar-inner">
				<div class="brand"><span id="productName" style="color: #953b39;">${fns:getConfig('productName')}</span></div>
				<ul id="userControl" class="nav pull-right">
					<li><a href="#" title="${fns:getConfig('productName')}"><i class="icon-home"></i></a></li>
